      	...
      	if (n!=-1)
		{
			try
			{
				...
				String min=(time.substring(n+1,l));
      			...
      			{
					System.out.println ("To Calculate angle between the hour and min hand of an analog clock if hour hand is at "+hr+" hour and min hand is at "+min);
					System.out.println(handleAngle(hour,minute));  
				}
			}
